...
bin/mallet train-topics --input scriptOutput/mytrans.mallet --num-topics 50 --output-state scriptOutput/$STATE --output-topic-keys scriptOutput/$KEYS --output-doc-topics scriptOutput/$COMP --random-seed 1
done
